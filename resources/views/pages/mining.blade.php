            ...
            <div class="col-xl-12">
              <div class="row py-3">
                @foreach ($bots as $bot => $donnees)
                    @if ($donnees->nom == 'BOT_VIP0')
                        <div class="col-md-3 mx-auto mb-3">
                            <div class="card">
                            <div class="card-header mx-4 p-3 text-center">
                                <div class="icon icon-shape icon-lg bg-gradient-dark shadow text-center" style="border-radius:50%;">
                            ...
                            <div class="card-body pt-0 p-3 text-center">
                                ...
                                <button type="submit" class="btn btn-lg mx-auto bg-gradient-dark">{{ __("Miner") }} <i class="fas fa-hammer text-sm"></i></button>
                            </div>
                            </div>
                        </div>
                    @endif
                    @if ($donnees->nom == 'BOT_VIP1')
                        <div class="col-md-3 mx-auto mb-3">
                            <div class="card">
                            <div class="card-header mx-4 p-3 text-center">
                            ...
                            <div class="card-body pt-0 p-3 text-center">
                                ...
                                <span class="text-xs">{{ __("Montant fourni par jour") }}</span>
                                <h5 class="mb-3 mt-2">{{ $donnees->montant_fourni }} XAF</h5>
                                <button type="submit" class="btn btn-lg mx-auto bg-gradient-primary">{{ __("Miner") }} <i class="fas fa-hammer text-sm"></i></button>
                            </div>
                            </div>
                        </div>
                    @endif
                    @if ($donnees->nom == 'BOT_VIP2')
                        <div class="col-md-3 mx-auto mb-3">
                            <div class="card">
                            <div class="card-header mx-4 p-3 text-center">
                                <div class="icon icon-shape icon-lg bg-gradient-info shadow text-center" style="border-radius:50%;">
                                <i class="fas fa-robot opacity-10 " style="font-size: 25px"></i>
                                </div>
                            </div>
                            <div class="card-body pt-0 p-3 text-center">
                                ...
                                <span class="text-xs">{{ __("Montant fourni par jour") }}</span>
                                <h5 class="mb-3 mt-2">{{ $donnees->montant_fourni }} XAF</h5>
                                <button type="submit" class="btn btn-lg mx-auto bg-gradient-info">{{ __("Miner") }} <i class="fas fa-hammer text-sm"></i></button>
                            </div>
                            </div>
                        </div>
                    @endif
                    @if ($donnees->nom == 'BOT_VIP3')
                        <div class="col-md-3 mx-auto mb-3">
                            <div class="card">
                            <div class="card-header mx-4 p-3 text-center">
                                <div class="icon icon-shape icon-lg bg-gradient-warning shadow text-center" style="border-radius:50%;">
                                <i class="fas fa-robot opacity-10 " style="font-size: 25px"></i>
                                </div>
                            </div>
                            <div class="card-body pt-0 p-3 text-center">
                                ...
                                <span class="text-xs">{{ __("Montant fourni par jour") }}</span>
                                <h5 class="mb-3 mt-2">{{ $donnees->montant_fourni }} XAF</h5>
                                <button type="submit" class="btn btn-lg mx-auto bg-gradient-warning">{{ __("Miner") }} <i class="fas fa-hammer text-sm"></i></button>
                            </div>
                            </div>
                        </div>
                    @endif
                    @if ($donnees->nom == 'BOT_VIP4')
                        <div class="col-md-3 mx-auto mb-3">
                            <div class="card">
                            <div class="card-header mx-4 p-3 text-center">
                                <div class="icon icon-shape icon-lg bg-gradient-danger shadow text-center" style="border-radius:50%;">
                                <i class="fas fa-robot opacity-10 " style="font-size: 25px"></i>
                                </div>
                            </div>
                            <div class="card-body pt-0 p-3 text-center">
                                ...
                                <span class="text-xs">{{ __("Montant fourni par jour") }}</span>
                                <h5 class="mb-3 mt-2">{{ $donnees->montant_fourni }} XAF</h5>
                                <button type="submit" class="btn btn-lg mx-auto bg-gradient-danger">{{ __("Miner") }} <i class="fas fa-hammer text-sm"></i></button>
                            </div>
                            </div>
                        </div>
                    @endif
                    @if ($donnees->nom == 'BOT_VIP5')
                        <div class="col-md-3 mx-auto">
                            <div class="card">
                            <div class="card-header mx-4 p-3 text-center">
                                <div class="icon icon-shape icon-lg bg-gradient-success shadow text-center" style="border-radius:50%;">
                                <i class="fas fa-robot opacity-10 " style="font-size: 25px"></i>
                                </div>
                            </div>
                            <div class="card-body pt-0 p-3 text-center">
                                ...
                                <span class="text-xs">{{ __("Montant fourni par jour") }}</span>
                                <h5 class="mb-3 mt-2">{{ $donnees->montant_fourni }} XAF</h5>
                                <button type="submit" class="btn btn-lg mx-auto bg-gradient-success">{{ __("Miner") }} <i class="fas fa-hammer text-sm"></i></button>
                            </div>
                            </div>
                        </div>
                    @endif
