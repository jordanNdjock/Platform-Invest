...
<head>
  ...
  <title>
    Platform Link/{{ __("Tableau de Bord") }}
  </title>
  <!--     Fonts and icons     -->
...
<body class="g-sidenav-show   bg-gray-100">
    <div class="position-absolute w-100 min-height-300 top-0" style="background-image: url('https://cdn.pixabay.com/photo/2016/12/08/21/21/skyscrapers-1893201_1280.jpg'); background-position-y: 50%;">
      ...
      <div class="row">
        @if (Session::has('success'))
            <div class="alert alert-success alert-dismissible fade show text-white" role="alert">
                  {{ __(Session::get('success'))}} <b>{{Str::upper(Auth::user()->name)  }}</b>
