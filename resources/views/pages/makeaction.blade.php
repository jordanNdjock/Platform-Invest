                ...
                <div class="row">
                  <div class="col-md-6 mb-md-0 mb-4 justify-content-center">
                    <div class="card card-body card-plain border-radius-lg d-flex align-items-center flex-row ">
                        <button class="btn bg-gradient-success col-12" type="submit"><span class="h4 text-white">{{ Str::upper(__("depôt"))}}</span><i class="fas fa-hand-holding-dollar text-lg mx-2"></i></button>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="card card-body card-plain border-radius-lg d-flex align-items-center flex-row">
